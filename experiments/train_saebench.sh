...
FP8="${FP8:-0}"                # 1 -> train the batchtopk_fp8 variant (non-TE, torch._scaled_mm)
FP8_TE="${FP8_TE:-0}"          # 1 -> train the batchtopk_te_fp8 variant (TransformerEngine); dir suffix _fp8te
...
echo "  lr=${LR:-default 3e-4}  batch=${BATCH_SIZE:-default 2048}  fp8=${FP8}  fp8_te=${FP8_TE}  tag=${RUN_TAG:-<none>}"
